...
public class AssertJTest {
    ...
    /*
    *   Assertj 는 메소드 체이닝을 지원하기 때문에 좀 더 깔끔하고 읽기 쉬운 테스트 코드를 작성할 수 있다.
    *   개발자가 테스트를 하면서 필요하다고 생각하는 거의 모든 기능을 메소드로 제공하고 있다.
    *   참고 hamncrest, truth 등도 사용하는 용법이나 컨셉이 비슷하지만 보통 assertj 를 많이 사용한다.
    *   가장 직관적이고 편하며, junit5 팀에서도 공식적으로 추천하고 있는 thrid party lib 이다.
    * */
    ...
    void testLocalDateTimeValidation(){
        ...
        //then
        Assertions.assertThat(thatDay) // 대상값 지정
                .hasYear(2014)
                .hasMonthValue(9)
                .hasDayOfMonth(18)
    ...
    // 예외 내용이 검증하는 것 또한 예외 타입, 예외 메시지 등을 검증할 수 있다.
    @Test
    @DisplayName("예외테스트하기")
    ...
    void testExceptionValidation2(){
        ...
        * 2. assertThatIllegalArgumentExcetion
    ...
    void testExtractProperty() {
        ...
        //then
        Assertions.assertThat(members)
                .extracting("name", String.class) // 적출
    ...
    void testExtractPropertyTuple() {
        ...
        // 셀 수 있는 수량의 순서 있는 열거 또는 어떤 순서를 따르는 요소들의 모음을 튜플 이라고 함.
        //then
        Assertions.assertThat(members)
                .extracting("name", "age")
                .contains(
